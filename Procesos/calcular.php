    ...
    <body class="has-js">
                ...
                <fieldset class="checkboxes">
                    <table boder="0" style="position: relative; width: 100%;">                        
                        <tr>
                            <td colspan="2">                                
                                <div id="footer">
                                    <a href="#" onclick="fun_calcularPeso()">Procesar</a>                
                                </div>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="div_cargado">
            ...
            <div id="f1_upload_process2" class="cargado2 finaliza">
                ...
                <label style="color: #4A5F96;"><b>Calculando pesos...</b></label><label style="color: #4A5F96;">espere un momento</label>
            </div>
        </div>
    </body>
</html>
<script type="text/javascript">
    ...
    function fun_calcularPeso(){
        var question = confirm("Desea recalcular los pesos..?");
        if(question == true){
            startUpload();//Invocando al mensaje del cargado
            $("#sp_men").html("");
            $.post('CalculoDetalle.php',{
                det:1
            },function(){
