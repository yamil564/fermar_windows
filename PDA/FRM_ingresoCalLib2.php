...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        ...
        <b>&nbsp;&nbsp;&nbsp;<?php echo $area . ' > '; ?><label id="lblProcesoDes" style="color: #5776fc;"><?php echo $respProc['pro_vc50_desc']; ?></label></b></label>
        <br /><label style="font-size: 12px; position: relative; float: right;"><b><?php echo $arrSession[3]; ?></b></label>
        ...
        <form name="form" method="post">
            ...
            <br /><label style="font-weight: bold; color: #010101;">Supervisor</label>
                <li>
...
<script type="text/javascript" src="js/Inspeccion_Calidad/Final/Final2.js"></script>