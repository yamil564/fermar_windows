...
class CLS_CalArm extends PDF_addonXMP {
    ...
    function Header() {
        ...
        $this->SetFont('Arial', 'B', 9);
        $this->SetTextColor(23);
        $this->MultiCell(90, 4, utf8_decode('SISTEMA DE GESTIÓN DE LA CALIDAD'), '0', 'C', '', false);

        $this->SetY(14);
        $this->SetX(85);
        $this->SetFont('Arial', 'B', 7);
        $this->SetTextColor(23);
        $this->MultiCell(60, 4, utf8_decode('REGISTRO DE INSPECIÓN DE ARMADO'), 0, 'C', '', false);

        $this->SetY(7);
        $this->SetX(176);
        $this->SetFont('Arial', 'B', 6);
        $this->SetTextColor(23);
        $this->MultiCell(25, 4, utf8_decode('Codigo     :  F-CC-002'), '', 'L', '', false);
