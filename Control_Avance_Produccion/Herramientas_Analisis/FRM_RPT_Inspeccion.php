...
/*
  ...
  |---------------------------------------------------------------
  | Pagina donde selecciono parametros para el reporte  RPT_Inspeccion.php
 */
?>
            ...
            <div>
                <table border="0" style=" width: 100%">
                    ...
                    <tr>
                     ...
                     <tr style="height: 5px;">
                        <td></td>
                        <td colspan="7"><label style="width: 100px !important;"><input type="checkbox" id="chk_Cal" name="chk_Cal" />&nbsp;Calcular Peso</label></td>
                    </tr>
                </table>
            </div>
        </form>
