...
/*
  |---------------------------------------------------------------
  | PHP FRM_RPT_Inspeccion_Final.php
  |---------------------------------------------------------------
  ...
  |---------------------------------------------------------------
  | Pagina donde selecciono parametros para el reporte  FRM_RPT_Inspeccion_Final
 */
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body>
        ...
        $obj_ort = $Cls_Herramienta->SP_lista_Orden_Calidad_Final();
        ?>
