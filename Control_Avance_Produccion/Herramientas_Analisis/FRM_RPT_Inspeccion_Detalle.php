...
/*
  |---------------------------------------------------------------
  | PHP FRM_RPT_Inspeccion_Detalle.php
  |---------------------------------------------------------------
  ...
  |---------------------------------------------------------------
  | Pagina donde selecciono parametros para el reporte  FRM_RPT_Inspeccion_Detalle
 */
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body>
        ...
        $obj_ort = $Cls_Herramienta->SP_lista_Orden_Calidad_Detalle();
        ?>
        ...
        <form action="" id="busRPT_Inspeccion">
            <div>
                <table border="0" style=" width: 100%">
                    ...
                    <tr>
                        <td ><td colspan="4"><input type="checkbox" id="chk_firma" name="chk_firma" value="1"/>&nbsp; Con firma</td></td>
                        <td ></td>
                        <td ></td>
                        <td ></td>
                        <td ></td>
