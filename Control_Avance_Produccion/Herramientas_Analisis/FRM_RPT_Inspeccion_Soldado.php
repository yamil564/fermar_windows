...
/*
  |---------------------------------------------------------------
  | PHP FRM_RPT_Inspeccion_Soldado.php
  |---------------------------------------------------------------
  ...
  |---------------------------------------------------------------
  | Pagina donde selecciono parametros para el reporte  FRM_RPT_Inspeccion_Soldado
 */
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body>
        ...
        $obj_ort = $Cls_Herramienta->SP_lista_Orden_Calidad_Soldado();
        ?>
