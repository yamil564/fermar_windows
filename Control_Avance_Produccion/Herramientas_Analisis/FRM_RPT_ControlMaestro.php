...
/*
  |---------------------------------------------------------------
  | PHP FRM_RPT_ControlMaestro.php
  |---------------------------------------------------------------
  ...
  |---------------------------------------------------------------
  | Pagina donde selecciono parametros para el reporte  FRM_RPT_ControlMaestro.php
 */
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body>
        ...
        $obj_ort = $Cls_Herramienta->SP_lista_InspProd_All();
        ?>
                ...
                <table border="0" style=" width: 100%">
                    ...
                    <tr>
                        <td colspan="3" style="text-align: right;">
                            <label for="r1" style="width: 100px;"><input type="radio" name="r1" id="r1" title="Exportar PDF" checked value="1"/>&nbsp;Exportar PDF</label>
                        </td>
                        <td colspan="1" style="text-align: right;">
                            <label for="r2" style="width: 100px;"><input type="radio" name="r1" id="r2" title="Exportar XLS" value="2" />&nbsp;Exportar XLS</label>
                        </td>
                        <td colspan="3" style="text-align: left;">
                            <label for="r3" style="width: 140px;"><input type="radio" name="r1" id="r3" title="Exportar XLS" value="3" />&nbsp;Reporte en VIVO!</label>
                        </td>
                        <td colspan="1"></td>
                    </tr>
                </table>
