...
|---------------------------------------------------------------
| Página en donde se encuentra el formulario y JqGrid del proceso de  Fusion
*/
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
<head>
    <title>Registro de Fusions</title>
        ...
        <div id="ul">
            ...
            <div id="tab_container" class="tab_containerShow">
                ...
                <div id="tabs-1" class="tab_content">
                    <?php echo '<table id="tblFusion"></table>'; ?>
                    <div id="PagFusion"></div>
                </div>
                <?php if($dat['acc_in1_nue']!=0){ ?>
                <div id="tabs-2" class="tab_content">
                    <!--Formulario para ingresar datos de las Fusions-->
    ...
    <?php echo '<script type="text/javascript" src="Script/Planificacion_Produccion/Servicios/Fusion.js'.'?'.filemtime('../../../Script/Planificacion_Produccion/Servicios/Fusion.js').'"</script>'; ?>
</body>
</html>