...
|---------------------------------------------------------------
| Página en donde se encuentra el formulario y JqGrid de los Proyectos
*/
?>
...
<head>
        ...
        <div id="ul">
            ...
            <div id="tab_container" class="tab_containerShow">
                ...
                <div id="tabs-1" class="tab_content">
                    <?php echo '<table id="tblProyecto"></table>'; ?>
                    <div id="PagProyecto"></div>
                </div>
                <?php if($dat['acc_in1_nue']!=0){ ?>
                <div id="tabs-2" class="tab_content">
                    <!--Formulario para ingresar datos del Proyecto-->
                    <form name="Proyecto" id="Proyecto" action="">
                        <div class="div-pest">
                            <ul>
                                <li>
                                    <label id="txt_proy_cod2" for="txt_proy_cod">C&oacute;digo:</label>
                                    <input type="text" name="txt_proy_cod" id="txt_proy_cod" class="data-entry" readonly="readonly" />
                                </li>
                                <li>
                                    <label for="txt_proy_nom">Nombre:</label>
                                    <input type="text" name="txt_proy_nom" id="txt_proy_nom" class="letras data-entry" maxlength="150" style="width: 200px;"  />
    ...
    <?php echo '<script type="text/javascript" src="Script/Planificacion_Produccion/Servicios/proyecto.js'.'?'.filemtime('../../../Script/Planificacion_Produccion/Servicios/proyecto.js').'"</script>'; ?>
</body>
</html>