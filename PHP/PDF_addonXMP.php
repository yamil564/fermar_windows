...
/*
  |---------------------------------------------------------------
  | PHP PDF_addonXMP.php
  |---------------------------------------------------------------
  | @Autor: Gerardo D. Ayquipa de la Cruz
  | @Fecha de creación: 15/07/2011
  | @Modificado por: Gerardo D. Ayquipa de la Cruz, Frank Peña Ponce
  | @Fecha de modificacion: 28/09/2011
  | @Organización: KND S.A.C.
  |---------------------------------------------------------------
  | Pagina de ayuda con funciones complementarias para la libreria FPDF
 */
require_once '../../Reportes/Class/fpdf/fpdf.php';
date_default_timezone_set("America/Lima");

class PDF_addonXMP extends FPDF {
    /* Variables para la paginacion con grupos en FPDF */
...
//________________ Fonction encodage et dessin du code 128 _____________________
    ...
    /* Variables de la funcion para corte del reporte */
    var $widths;
    var $aligns;
    var $color;
    /* Seccion en donde se realiza la funcion para corte del reporte */
    ...
    function Row($data, $interline, $border = null) {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $z = ($this->color == true) ? $this->color = true : $this->color = false;
            ...
            //Print the text
            $this->MultiCell($w, 5, $data[$i], 0, $a, $z);
            //Put the position to the right of the cell
            $this->SetXY($x + $w, $y);
        }
        $this->SetY($y + $interline);
        //Go to the next line
        $this->Ln($h);
    }
