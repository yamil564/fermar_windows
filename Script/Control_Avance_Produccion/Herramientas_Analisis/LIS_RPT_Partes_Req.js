...
$(document).ready(function(){
    ...
    $.post('Control_Avance_Produccion/Herramientas_Analisis/FRM_RPT_Partes_Req.php',{},function(data){
        $("#dialog-reports").html(data);
        $('#dialog-reports').dialog({
            title:"Requisicion de Partes",
            maxWidth:496,
            minWidth:496,
            maxHeight:145,
            minHeight:145,
            ...
            buttons:{
                ...
                "Aceptar":function(){
                    ...
                    window.open('Reportes/Partes/RPT_Partes_Req.php?&cbo_tip='+cbo_tip);
                    $(this).dialog("close");
                    $(this).dialog("destroy");
                }
            }
