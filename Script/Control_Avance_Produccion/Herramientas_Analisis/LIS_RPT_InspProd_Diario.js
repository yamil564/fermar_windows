...
| @Fecha de creacion: 11/11/2011
| @Fecha de la ultima modificacion:11/11/2011
...
$(document).ready(function(){
    ...
    $.post('Control_Avance_Produccion/Herramientas_Analisis/FRM_RPT_InspProd_Diario.php',{},function(data){
        $("#dialog-reports").html(data);
        $('#dialog-reports').dialog({
            title:"Reporte de Avance de Producción",
            maxWidth:496,
            minWidth:496,  
            maxHeight:145,
            minHeight:145,
            ...
            buttons:{
                ...
                "Aceptar":function(){
                    ...
                    window.open('Reportes/Produccion/RPT_AvanceProduccion.php?ot='+cbo_tip);
                    $(this).dialog("close");
                    $(this).dialog("destroy");
                }
            }
