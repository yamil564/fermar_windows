...
qq.FileUploader = function(o){
    this._options = {
        ...
        fileTemplate: '<li>' +
                ...
                '<span class="qq-upload-failed-text">Fallido</span>' +
            '</li>',
        ...
        messages: {
            ...
            typeError: "{file} tiene extension invalida. Solo {extensions} son permitida.",
            sizeError: "{file} es demasiado grande, tamaño maximo del archivo es {sizeLimit}.",
            emptyError: "{file} esta vacio, por favor selecione otra vez el archivo sin el."
        },
