...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body>
        ...
        $procCali= $SP_Final->SP_ListProcCal(14);
        $cad = '';
            ...
            <div id="tabs-1" class="tab_content">
                <form id="final" name="final" action="" method="post">    
                    ...
                    <table border="0" style="border-spacing: 5px;">
                        ...
                        <tr>
                            <td><label class="lblProdCal" for="txt_item" >Ingrese Ítem:</label>&nbsp;<input style="width: 150px;" id="txt_item" name="txt_item" onkeypress="enterItem(event)" />&nbsp;<img id="imgRenovar" style="cursor: pointer; width: 20px; height: 20px; position: relative; top: 6px;" src="Images/cancelar.png" title="Borrar" onclick="renovar()" /></td>
                        ...
                        <tr>
                            <td><label for="cbo_cal_varLarg" class="lblProdCal">Largo variante :</label>&nbsp;<select id="cbo_cal_varLarg" style="width: 156px;"><?php echo $cad; ?></select></td>
                            <td><label for="cbo_cal_varLong" class="lblProdCal">Ancho variante :</label>&nbsp;<select id="cbo_cal_varLong" style="width: 110px;"><?php echo $cad; ?></select></td>
                            <td><input type="text" id="txtSaveItems" name="txtSaveItems" style="width: 0px; height: 0px;" onkeypress="saveItem(event)" /></td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <br /><br /><br /><br />
        ...
        <?php echo '<script type="text/javascript" src="Script/Control_Calidad_Produccion/Control_Inspeccion/Inspeccion_Final/Final.js' . '?' . filemtime('../../../Script/Control_Calidad_Produccion/Control_Inspeccion/Inspeccion_Final/Final.js') . '"</script>'; ?>
    </body>
</html>